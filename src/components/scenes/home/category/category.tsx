          ...
          {categories.map((category) => {
            ...
            return (
              <Button
                key={category.id}
                variant="ghost"
                className="bg-[#EDEDED] cursor-pointer hover:bg-[#E0E0E0] rounded-2xl h-auto p-6 flex flex-col items-center justify-center gap-3 transition-all duration-200 hover:shadow-md group border-0"
              >
